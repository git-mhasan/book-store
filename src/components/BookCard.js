...
import deleteBookThunk from '../redux/booksFeature/thunk/deleteBookThunk';

const BookCard = ({ book, setEditId }) => {
            ...
            <div className="flex-1 h-full pr-2 pt-2 flex flex-col">
                ...
                <div className="space-y-2 mt-4 h-full">
                    ...
                    <div className="lws-stars">
                        ...
                        {ratingArray(rating).map(star => {
                            return <svg viewBox="0 0 20 20" fill="currentColor" className="lws-star" key={star}>
