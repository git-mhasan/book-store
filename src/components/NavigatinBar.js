...
const NavigatinBar = ({ setSearchText, searchText }) => {
            ...
            <div className="container flex items-center justify-between">
                ...
                <form className="flex items-center" onSubmit={handleFormSubmit}>
                    <div className="group relative rounded-md bg-white">
                        ...
                        <input type="text" placeholder="Filter books..." className="search" id="lws-searchBook" value={searchText} onChange={searchHandler} />
                    </div>
                </form>
            </div>
        </nav>
